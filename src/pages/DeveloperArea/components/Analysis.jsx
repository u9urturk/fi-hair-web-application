                ...
                <div className='fixed left-0 top-0 w-full h-screen backdrop-blur-sm flex items-center justify-center'>
                    ...
                    <div>
                        <div ref={ref} className='flex flex-col gap-y-4'>
                            <ul id='age' className='flex flex-col px-4 py-6 rounded-xl bg-brand-color bg-opacity-70 border-white border-2 gap-y-2  items-center justify-center h-auto max-w-4xl w-[200px]'>
                                <strong>Yaş</strong>
                                {
                                    ages.map(age => {
                            ...
                            <div id='zx' className='hidden flex items-center justify-center flex-col bg-brand-color bg-opacity-70 border-white border-2 rounded-xl px-4 py-6 gap-y-2'>
                            ...
                            <ul id='zy' className='flex hidden flex-col rounded-xl items-center justify-center px-4 py-6 bg-brand-color bg-opacity-70 border-white border-2 gap-y-2'>
                            ...
                            <ul id='xy' className=' hidden flex-col rounded-xl  items-center justify-center  px-4 py-6 bg-brand-color bg-opacity-70 border-white border-2 '>
                            ...
                            <ul id='xx' className=' hidden flex flex-col rounded-xl   items-center justify-center  px-4 py-6 bg-gray-200 gap-y-4'>
                                <strong>Saçınızın Dökülme Tipini Seçin</strong>
                                <div className='grid grid-cols-2 grid-flow-row gap-4 pt-3'>
                                    {
                                        xxImages.map(image => {
                            ...
                            <div id='name'  className='hidden'>
                                ...
                                <div className='flex  flex-col items-center justify-center w-full h-14  '>
                                    <input className='w-full h-[44px]' type="text" placeholder='Adınız Soyadınız' />
                                    <div className='flex items-center justify-center '>
                                        ...
                                        />
                                        <input type="text" className='h-[44px]'  placeholder='Telefon numaranız'/>
                                    </div>
                                </div>
                            </div>
