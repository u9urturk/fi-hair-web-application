...
export default function FemaleType() {
    ...
    return (
        <div className='relative w-auto h-96 xl:h-screen bg-cover bg-no-repeat' style={{ backgroundImage: `url(${femaletype}` }} >
            <div className='absolute left-8 top-48 md:top-32 text-sm md:text-3xl font-serif font-semibold text-gray-800 max-w-[30%] w-full'>Kadınlarda da Erkek Tipi Saç Dökülmesi Olabilir</div>
