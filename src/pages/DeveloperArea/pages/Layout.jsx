...
export default function Layout() {
  ...
  return (
    <div className='relative '>
      ...
      <WhyFihair></WhyFihair>      
      <div className='fixed flex item-center justify-center group  -left-8 bottom-2 h-auto w-auto '>
        <a href="https://wa.me/905380497824" target="_blank"> <img className='w-40 h-auto transition-all active:scale-95 cursor-pointer hover:scale-105' src={whatsapp} alt="" /></a>
       
        <p className='hidden border border-spacing-3 h-12 py-2 px-4  rounded-full -translate-x-10 translate-y-5 text-gray-900 border-gray-800 group-hover:block'>Size nasıl yardımcı olabiliriz ?</p>
      </div>
